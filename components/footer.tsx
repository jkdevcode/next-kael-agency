...
export function Footer() {
  ...
  const socialLinks = [
    { icon: "mdi:instagram", href: "https://www.instagram.com/nexus__.landingstudio?igsh=MWFzd3Y4ZGxid3loMQ", label: "Instagram" },
    { icon: "mdi:whatsapp", href: "https://wa.me/5712345678", label: "WhatsApp" },
  ]
      ...
      <div className="container max-w-7xl mx-auto px-6">
        ...
        <div className="pt-8 border-t border-neutral-200 dark:border-neutral-900 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-neutral-500 dark:text-neutral-500">
          ...
          {/* <div className="flex items-center gap-2">
            <span>Hecho con</span>
            <Icon icon="solar:heart-bold" className="text-red-500 w-4 h-4" />
            <span>en Bogotá</span>
          </div> */}
        </div>
      </div>
